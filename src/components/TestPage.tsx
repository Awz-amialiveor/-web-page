  ...
  if (!started) {
    ...
    return (
      <div className={bgGradient}>
        <section className="min-h-screen pt-24 sm:pt-32 pb-16 sm:pb-24 px-4 sm:px-6 md:px-8 relative overflow-hidden flex items-center justify-center">
  ...
  if (completed && result) {
    ...
    return (
      <div className="min-h-screen relative">
        {/* Optimized Background Image with lazy loading simulation */}
        {bgImage && (
          <div 
        ...
        {!bgImage && (
          <div 
            ...
            style={{ 
              background: 'linear-gradient(to bottom, var(--theme-from), var(--theme-via), white)'
            }}
          />
        )}
        
        <section className="relative z-10 pt-20 sm:pt-24 pb-16 sm:pb-24 px-4 sm:px-6 md:px-8">
