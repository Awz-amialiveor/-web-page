...
export default function MainPage({ language }: MainPageProps) {
  const t = translations[language];

  return (
    <div className="bg-black">
      {/* Hero Section - Dramatic Gradient */}
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-b from-black via-zinc-800 to-white">
        <div className="absolute inset-0 z-0 opacity-10">
          <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] rounded-full border-[40px] border-white/20"></div>
          <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full border-[30px] border-white/10"></div>
        </div>
        
        {/* Subtle red accent line */}
        <div className="absolute top-40 left-0 w-64 h-[1px] bg-gradient-to-r from-transparent via-[var(--theme-accent)]/30 to-transparent"></div>
        <div className="absolute bottom-40 right-0 w-64 h-[1px] bg-gradient-to-l from-transparent via-[var(--theme-accent)]/30 to-transparent"></div>
          ...
          >
            ...
            <div className="mb-4 flex justify-center">
              <img 
                src={birdLogo} 
                alt="Homecoming" 
                className="w-20 h-20 object-contain invert opacity-90"
              />
            </div>

            {/* Title */}
            <h1 className="mb-8 text-[5rem] leading-[0.9] text-white tracking-[0.3em]" style={{ fontWeight: 300 }}>
              {t.heroTitle}
            </h1>
            ...
            <p className="text-2xl text-white/60 mb-8 tracking-wide" style={{ fontWeight: 300 }}>
              {t.heroSubtitle}
            </p>
